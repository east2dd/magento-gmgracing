	...
	if( count( $data['data'] ) > $display ):
		...
		*/
		...
		for( $i=0; $i < $query; $i++ ):
			...
			*/
			//var_dump($data['data'][$i]['images']);
			$output .= '<div class="item-holder" data-id="' . $data['data'][$i]['id'] . '">';
			$output .= '<a href="' . $data['data'][$i]['link'] . '" target="_blank">';
			$output .= '<img class="front-photo" src="' . sInstCache( $data['data'][$i]['images']['low_resolution']['url'], "300" ) . '" width="300" height="300" title="' . $data['data'][$i]['caption']['text'] . '">';
			$output .= '</a>';
			$output .=  '</div>';
				 ...
				 */
				 ...
				 $output .= '<span class="scode-content-info like"><img src="' . plugins_url('/simply-instagram/images/instagram-like.png') . '" width="12" height="12" style="vertical-align: middle;"  /> ' . $data['data'][$i]['likes']['count'] . '</span>';
				 $output .= '<span class="scode-content-info comment"><img src="' . plugins_url('/simply-instagram/images/instagram-comment.png') . '" width="12" height="12" style="vertical-align: middle;" /> ' . $data['data'][$i]['comments']['count'] . '</span>';
				 $output .= '</div>';
				 endif;
